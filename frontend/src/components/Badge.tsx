...
const variantClasses: Record<BadgeVariant, string> = {
  critical:
    "bg-[var(--color-accent-danger)]/15 text-[var(--color-accent-danger)] border-[var(--color-accent-danger)]/30",
  high: "bg-[var(--color-accent-danger)]/10 text-[var(--color-accent-danger)] border-[var(--color-accent-danger)]/20",
  medium:
    "bg-[var(--color-accent-warning)]/15 text-[var(--color-accent-warning)] border-[var(--color-accent-warning)]/30",
