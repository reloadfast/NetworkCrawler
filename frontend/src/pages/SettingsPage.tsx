        ...
        <Card>
          <dl className="divide-y divide-[var(--color-border)]">
            <div className="flex items-center justify-between py-3">
              <dt className="text-sm text-[var(--color-text-secondary)]">Version</dt>
              <dd className="flex items-center gap-2">
                {loading ? (
                  ...
                  <button
                    ...
                    className="font-mono text-sm text-[var(--color-text-primary)] transition-colors duration-150 hover:text-[var(--color-accent-positive)] select-none"
                  >
            ...
            <div className="flex items-center justify-between py-3">
              <dt className="text-sm text-[var(--color-text-secondary)]">Source</dt>
